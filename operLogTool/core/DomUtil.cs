...
namespace opeLogTool.core
{
    ...
    public class DomUtil
    {
            ...
            bool bReturnFirstNode = true)
        {
            ...
            {
                string strThisLang = GetAttr(nodes[i], "lang");
            ...
            bool bReturnFirstNode = true)
        {
            ...
            for (int i = 0; i < nodes.Count; i++)
            {
                string strThisLang = GetAttr(Ns.xml, nodes[i], "lang");
    ...
    out string strLangRight)
            ...
            out string strError)
        {
            ...
            string strValue = GetAttr(node, strParamName);
    ...
    out strError);
        ...
        public static string GetIndentInnerXml(string strXml)
        {
            ...
            return GetIndentInnerXml(dom.DocumentElement);
        }
            ...
            string strXpath)
        {
            ...
            return CreateNode(nodeRoot, aNodeName);
        }
            ...
            for (; i < aNodeName.Length; i++)
            {
                ...
                if (temp == null)
                {
                    ...
                    if (firstChar == '@' && i == aNodeName.Length - 1)
                    {
                        ...
                        SetAttr(nodeCurrent, strAttrName, "");
            ...
            out string strError)
        {
            ...
            SetNodeText(nodeFound, strNewText);
            return 0;
        }
            ...
            while (node != null)
            {
                ...
                while (nodeTemp != null)
                {
                    if (nodeTemp == nodeMyself) //Equals(nodeTemp,nodeMyself))
                    {
                        ...
                        strXpath = nodeMyself.Name + "[" + Convert.ToString(nIndex) + "]" + strXpath;
                        break;
                    }
